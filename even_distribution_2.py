...
with open('Challenge Info\data_set_2.csv', 'r', newline='') as data:
...
with open('Challenge Info\density_set_2.csv', 'w', newline = '') as csvfile:
...
ax.set_ylabel('x2')
ax.set_zlabel('')
ax.set_title('Dataset 2 Uniform Selection')
